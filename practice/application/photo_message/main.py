...
class Location(object):
    ...
    def __init__(self, image_path):
        ...
        self.api_key = "5d5e7c7d2f13fca34e8d3d9a7abcab5b"
    ...
    def __get_image_ability(self):
        ...
        if img_exif:
            # 纬度数
            latitude_gps = img_exif.get('GPS GPSLatitude') or 'not'
            ...
            photo_take_time = self.judge_time_met(take_time)

            # if is_lie:
            #     print('图片拍摄时间: ',format_time)
            #     # return
            print(f'拍摄时间 :{photo_take_time}')
...
if __name__ == '__main__':
    # 女朋友发过来的图片【原图】
    # location = Location('/Users/SJX/Desktop/IMG_8754.jpg')
    #
    # # 找到女朋友的地理位置
    # location.run()
